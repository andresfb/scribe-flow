...
final class PieceItem extends Data
{
    public function __construct(
        ...
        public readonly int|Optional $timeline_id,
        public readonly int|Optional $storyline_id,
        public readonly int|Optional $style_id,
        public readonly string|Optional $title,
        public readonly string|Optional $idea,
