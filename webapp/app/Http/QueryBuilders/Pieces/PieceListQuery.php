...
namespace App\Http\QueryBuilders\Pieces;

use App\Http\QueryBuilders\Filters\DateFilter;
use App\Http\QueryBuilders\Filters\FuzzyFilter;
...
final class PieceListQuery extends QueryBuilder
{
    public function __construct(PieceListRequest $request)
    {
        ...
        $this->allowedSorts(
            ...
            AllowedSort::field('timeline', 'timeline_id'),
            AllowedSort::field('storyline', 'storyline_id'),
            AllowedSort::field('style', 'style_id'),
            ...
            ->allowedFilters(
                ...
                AllowedFilter::exact('timeline', 'timeline_id'),
                AllowedFilter::exact('storyline', 'storyline_id'),
                AllowedFilter::exact('style', 'style_id'),
